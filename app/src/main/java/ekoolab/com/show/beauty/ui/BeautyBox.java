...
public class BeautyBox extends LinearLayout implements Checkable {
    ...
    public BeautyBox(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textNormalColor = a.getColor(R.styleable.BeautyBox_textColor_normal, getResources().getColor(R.color.colorLightGray));
        textCheckedColor = a.getColor(R.styleable.BeautyBox_textColor_checked, getResources().getColor(R.color.colorBlueLight));
        ...
        boxText.setTextColor(getResources().getColor(R.color.colorLightGray));
