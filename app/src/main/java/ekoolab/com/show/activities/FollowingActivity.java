...
public class FollowingActivity extends BaseActivity implements View.OnClickListener,
    ...
    public static final String ACTION_REFRESH_DATA = "ekoolab.com.show.activity.FollowingActivity.refresh_data";
...
//        getFollowers(2);
    ...
    private void getFollowers(int flag){
        ...
        ApiServer.basePostRequest(this, Constants.MY_FOllOWING, map, new TypeToken<ResponseData<List<UserInfo>>>(){})
