...
public class BubbleView extends RelativeLayout {
    ...
    public BubbleView setDefaultDrawableList() {
        ...
        drawableList.add(getResources().getDrawable(R.mipmap.hear_blue));
        drawableList.add(getResources().getDrawable(R.mipmap.hear_green));
        drawableList.add(getResources().getDrawable(R.mipmap.hear_yellow));
        drawableList.add(getResources().getDrawable(R.mipmap.hear_red));
        drawableList.add(getResources().getDrawable(R.mipmap.footprint_blue));
        drawableList.add(getResources().getDrawable(R.mipmap.footprint_red));
        drawableList.add(getResources().getDrawable(R.mipmap.footprint_yellow));
        drawableList.add(getResources().getDrawable(R.mipmap.footprint_green));
        drawableList.add(getResources().getDrawable(R.mipmap.footprint_pink));
