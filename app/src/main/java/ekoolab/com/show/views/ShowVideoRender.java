...
public class ShowVideoRender extends BaseVideoRenderer {
    private final static String TAG = "ShowVideoRender";
    private Context context;
    private GLSurfaceView glSurfaceView;
    private MyRenderer mRenderer;

    public interface ShowVideoRenderListener {
        public void onMetadataReady(byte[] metadata);
    }

    public void setInvertedColorsVideoRendererMetadataListener(ShowVideoRenderListener metadataListener) {
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private ShowVideoRenderListener metadataListener;
        @Override
