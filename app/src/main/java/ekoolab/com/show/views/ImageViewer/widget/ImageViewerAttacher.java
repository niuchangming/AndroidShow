package ekoolab.com.show.views.ImageViewer.widget;
...
import ekoolab.com.show.views.ImageViewer.ImageViewerUtil;
import ekoolab.com.show.views.ImageViewer.TransitionCallback;
import ekoolab.com.show.views.ImageViewer.ViewData;
import ekoolab.com.show.views.ImageViewer.dragger.ImageDraggerType;
import ekoolab.com.show.views.ImageViewer.listener.OnImageChangedListener;
import ekoolab.com.show.views.ImageViewer.listener.OnItemClickListener;
import ekoolab.com.show.views.ImageViewer.listener.OnItemLongClickListener;
import ekoolab.com.show.views.ImageViewer.listener.OnPreviewStatusListener;
import ekoolab.com.show.views.ImageViewer.widget.viewpager.PreviewAdapter;
import ekoolab.com.show.views.ImageViewer.widget.viewpager.PreviewPager;
...
public class ImageViewerAttacher implements ViewPager.OnPageChangeListener {
    ...
    // 图片加载器
    private IyImageLoader mImageLoader;
    // 图片切换监听器
    ...
    public void setImageLoader(IyImageLoader loader) {
        mImageLoader = loader;
    }
